...
const productText: Record<string, Record<string, { name: string; desc: string }>> = {
  en: {
    ...
    anchor: { name: 'Anchor Bolts', desc: 'Anchor Bolts for Africa: Heavy-duty foundation bolts for Zimbabwe mining, South African construction, and East Africa infrastructure. ASTM F1554 Grade 36 (250 MPa) for light applications, Grade 55 (380 MPa) for structural mining foundations, Grade 105 (725 MPa) for critical loads. Hot-dip galvanized (HDG) to ISO 1461 — essential for Zimbabwe outdoor conditions where acidic soils and high rainfall rapidly corrode uncoated steel. Stainless steel 316 (A4) for coastal Kenya, Tanzania, Mozambique ports and chemical processing plants. Sizes M10-M30, lengths 75-1000mm. DIN 529 and ASTM F1554 compliant. Mill Test Reports (MTR) and material certificates provided. Supplied to Bindura Nickel, Mimosa Platinum, Hwange Coal mines. Sea freight to Durban, Beira, and Harare. MOQ 100 pieces per size, mixed sizes welcome.' },
  ...
  zh: {
    ...
    anchor: { name: '地脚螺栓', desc: '地脚螺栓-非洲专用：重型基础螺栓，适用于津巴布韦矿业、南非建设、东非基础设施。ASTM F1554 36级（250 MPa）用于一般用途，55级（380 MPa）用于矿业基础结构，105级（725 MPa）用于关键荷载。热镀锌（HDG）符合ISO 1461标准——对津巴布韦户外条件必不可少当地酸性土壤和高降雨量会快速腐蚀未镀锌钢材。不锈钢316（A4）用于肯尼亚、坦桑尼亚、莫桑比克沿海港口和化工厂。规格M10-M30，长度75-1000mm。符合DIN 529和ASTM F1554标准。提供材料测试报告（MTR）和材质证明。已供应Bindura镍矿、Mimosa铂矿、Hwange煤矿。海运至德班、贝拉和哈拉雷。MOQ 100件/规格，混规格欢迎。' },
