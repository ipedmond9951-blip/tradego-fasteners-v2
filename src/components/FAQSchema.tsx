...
const faqSchemaData: Record<string, Array<{ question: string; answer: string }>> = {
  en: [
    ...
    { question: "Which countries do you export to?", answer: "We export to 47 countries across Africa (Zimbabwe, South Africa, Kenya, Nigeria, Ghana), Middle East (UAE, Saudi Arabia), and Southeast Asia (Vietnam, Thailand). Africa accounts for 65% of our exports." },
    { question: "What are your most popular fastener products?", answer: "Our best-selling products are: 1) Drywall screws (3.5x25mm bugle head, fine thread) - 25% of orders, 2) Self-drilling TEK screws (#8x1/2 inch) - 20% of orders, 3) IBR roofing nails (3.05x75mm) - 18% of orders, 4) Hex bolts M10x50 Grade 8.8 - 15% of orders. We ship 50+ containers monthly to global clients." },
