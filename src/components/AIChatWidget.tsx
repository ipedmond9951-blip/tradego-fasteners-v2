        ...
        <div className="fixed bottom-24 right-6 w-80 bg-white rounded-xl shadow-2xl z-50 flex flex-col border border-gray-200" style={{ maxHeight: '70vh' }}>
          ...
          <div className="p-3 border-t border-gray-100 flex gap-2">
            <input
              ...
              className="flex-1 border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-1 focus:ring-primary-500 focus:border-transparent"
            />
            <button onClick={sendMessage} className="bg-primary-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-primary-700">
              {t(locale, 'chat.send')}
            </button>
          </div>
        </div>
