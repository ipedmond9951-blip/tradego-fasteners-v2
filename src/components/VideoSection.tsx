...
const otherLocales: Record<string, typeof translations.en> = {
  es: { title: 'Contenido de Video', subtitle: 'Vea nuestro proceso de fabricación, productos y testimonios en acción', factoryTitle: 'Tour de Fábrica', factoryDesc: 'Haga un recorrido virtual por nuestras instalaciones de fabricación', productTitle: 'Vitrina de Productos', productDesc: 'Vea demostraciones detalladas de nuestros productos', testimonialTitle: 'Testimonios', testimonialDesc: 'Escuche a clientes satisfechos sobre su experiencia', subscribe: 'Suscribirse', subscribeText: 'Suscríbase a nuestro canal de YouTube' },
...
export default function VideoSection({ locale }: VideoSectionProps) {
  ...
  const videos = [
    {
      id: 'factory',
      title: content.factoryTitle,
      description: content.factoryDesc,
      thumbnail: 'https://images.unsplash.com/photo-1565793298595-6a879b1d9492?w=800&h=450&fit=crop',
      placeholder: true
    },
    {
      id: 'product',
      title: content.productTitle,
      description: content.productDesc,
    ...
    },
    {
      ...
      description: content.testimonialDesc,
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-8">
          {videos.map((video) => (
            <button
              key={video.id}
              onClick={() => setActiveVideo(video.id as any)}
        ...
        <div className="max-w-4xl mx-auto">
          {videos.map((video) => (
            <div
              key={video.id}
              className={`${activeVideo === video.id ? 'block' : 'hidden'}`}
            >
              ...
              <div className="relative aspect-video bg-gray-900 rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-white/60 text-xs mt-4">Video coming soon</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 text-center">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">{video.description}</p>
              </div>
            </div>
          ))}
        </div>
