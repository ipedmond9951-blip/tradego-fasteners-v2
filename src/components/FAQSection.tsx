...
const faqKeys = [
  { q: 'What types of fasteners do you manufacture?', a: 'We manufacture a comprehensive range of fasteners for construction and industrial applications. Our main product categories include: drywall screws (bugle head, coarse and fine thread), self-drilling screws (TEK screws for metal-to-metal fastening), hex bolts and nuts (Grade 4.8, 8.8, 10.9), and IBR nails for roofing applications. All products are SABS & ISO 9001:2015 certified in our Hebei, China facility with 12+ years of Africa-focused experience. We specialize in serving African construction markets with sea freight to Durban, Lagos, and Mombasa. Custom specifications and various surface treatments including zinc plating, HDG, and dacromet available.' },
  ...
  // Africa-specific FAQ questions
  { q: 'Do your products meet SABS standards for South Africa?', a: 'Yes, our IBR nails and roofing fasteners comply with SABS 1195 (South African Bureau of Standards) requirements, essential for the South African construction market. We also manufacture products to DIN, ANSI, and ISO standards for projects requiring international certifications. Mill certificates and SABS-compliant test reports are available upon request with your order.' },
  { q: 'What payment methods do you accept for African customers?', a: 'We accept multiple payment methods suitable for African markets: T/T (wire transfer), L/C (letter of credit), and online payment platforms including Alipay and WeChat Pay for Chinese currency transactions. For new African customers, we recommend starting with a small trial order paid via T/T. We offer bulk order discounts up to 15% for African market customers to support construction projects across the continent.' },
  { q: 'How long does sea freight shipping take to African ports?', a: 'Shipping times to major African ports: Durban (South Africa): 25-30 days, Lagos/Nigerian ports: 30-35 days, Mombasa (Kenya): 28-32 days, Dar es Salaam (Tanzania): 28-33 days, Tema (Ghana): 30-35 days, Maputo (Mozambique): 25-30 days. We work with experienced freight forwarders who handle customs clearance documentation. CIF and DDP shipping terms available to help with import logistics.' },
  { q: 'Can you provide documentation for African customs clearance?', a: 'Yes, we provide complete export documentation for African customs: commercial invoice, packing list, Bill of Lading, Certificate of Origin (from CCPIT), fumigation certificates if required, and SGS or similar inspection certificates. For South African imports, we can provide SABS-compliant test reports. Our experienced logistics team ensures all documentation meets destination country requirements to avoid customs delays.' },
]
