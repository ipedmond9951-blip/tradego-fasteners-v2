    ...
    <section id="faq" className="py-12 md:py-16 lg:py-20">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-3xl mx-auto space-y-3 md:space-y-4">
          {faqKeys.map((faq, i) => (
            <details key={i} className="bg-white rounded-lg shadow-sm border border-gray-100 group">
              <summary className="px-4 md:px-6 py-3 md:py-4 cursor-pointer font-semibold text-gray-800 hover:text-blue-600 flex justify-between items-center text-sm md:text-base">
                {faq.q}
        ...
        <div className="text-center mt-8 md:mt-12">
          ...
          <a href={`/${locale}#inquiry`} className="inline-flex items-center gap-2 bg-blue-900 text-white px-5 md:px-6 py-2.5 rounded-lg font-semibold hover:bg-blue-800 transition-colors text-sm md:text-base">
