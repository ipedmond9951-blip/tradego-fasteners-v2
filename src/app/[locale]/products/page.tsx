...
const allProducts = [
  ...
  { slug: 'ibr-nails', image: '/images/products/ibr-nails-placeholder.webp', pricePerPiece: 0.01, nameKey: 'ibr', specs: { size: '2.5-4.0mm × 30-100mm', standard: 'SABS 1195', material: 'Q195/Q235 Wire', finish: 'Electro Galvanized' }, features: ['Umbrella head', 'Smooth/Ring shank', 'Roofing专用', 'SABS certified', 'Wholesale supplier'], applications: ['Roofing', 'Cladding', 'Construction', 'IBR roof sheeting', 'Wholesale bulk orders'] },
